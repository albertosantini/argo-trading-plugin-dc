...
const series = require("./ftse100-series").ftse100;
const strategy = require("../lib/signals/dc");
...
test("ftse100", t => {
    ...
    series.forEach(price => {
        const res = strategy.directionalChange("ftse100", price, threshold);
